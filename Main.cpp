...
int main()
{
    try // Any error results in program termination
    {
        ...
        cl::copy(queue, cbegin(vec_x), cend(vec_x), buf_x);


        // Launch kernels
        cl::Event kernel_event{ vecMean(cl::EnqueueArgs{ queue, cl::NDRange{ chainlength } },buf_x) };
        cl::Event kernel_event{ vecDev(cl::EnqueueArgs{ queue, cl::NDRange{ chainlength } },buf_x) };
